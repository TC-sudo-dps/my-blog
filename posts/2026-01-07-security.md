...
<div class="container">
    <h1>TC BLOG 文章編輯器</h1>
    <div class="hint">
        💡 <b>使用流程：</b> 在此寫完文章（可 Ctrl+V 貼圖） → 點擊「複製全文」 → 點擊「前往 GitHub 貼上」
    </div>
    ...
    <div class="field-group">
        <label>文章內容 (支援 Ctrl+V 貼上圖片)</label>
        <textarea id="content" placeholder="開始寫作..."></textarea>
    </div>

    <div class="btn-group">
        <button class="btn-copy" onclick="copyResult()">📋 複製全文代碼</button>
...
${content}`;
        ...
        navigator.clipboard.writeText(result).then(() => {
            alert('✅ 全文已複製！請到 GitHub 建立新檔案並貼上內容。');
        });
    }
</script>
</body>
